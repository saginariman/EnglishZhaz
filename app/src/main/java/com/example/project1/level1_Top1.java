...
public class level1_Top1 extends AppCompatActivity {
    // Сағиден Нариман ЕТжБ201
        ...
        setContentView(R.layout.total_level_interface);
            ...
            for(int r=0;r<40; r++){
                ...
                if(r%2==0){
                    ...
                    txvWordPanel.setText(String.valueOf(textnumber + " "+ WordsArrays.level1_top1_words[word]) );
                    word+=1;
                }else{
                    txvWordPanel.setText(WordsArrays.level1_top1_transfers[transfer]);
                    transfer+=1;
                }
            }
    ...
    public void ShowQustion(){
        ...
        try{
            ...
            /*for(int j=0;j<Stock.length;j++){
                ...
                RightResponse = WordsArrays.level1_top1_transfers[numRight];

                Stock[i] = numRight;

                mPlayer = MediaPlayer.create(this, WordsArrays.level1_top1_volums[numRight]);
                mPlayer.start();
                ...
                LevelTextView.setText(WordsArrays.level1_top1_words[numRight]);
                ...
                ResTvx1.setText(WordsArrays.level1_top1_transfers[numRight]);
                ...
                ResTvx2.setText(WordsArrays.level1_top1_transfers[num2]);
                ...
                ResTvx3.setText(WordsArrays.level1_top1_transfers[num3]);
                ...
                ResTvx4.setText(WordsArrays.level1_top1_transfers[num4]);
                ...
                ResTvx5.setText(WordsArrays.level1_top1_transfers[num5]);
            }
            else{
                TextView LevelTextView = (TextView)findViewById(R.id.level1textview);
    ...
    public  void OnClickVolumButton(View view){
        mPlayer = MediaPlayer.create(this, WordsArrays.level1_top1_volums[Stock[i]]);
